...
import Pagination from './index'; // 실제 경로에 맞게 변경해주세요

describe('<Pagination />', () => {
  it('renders the correct number of pages based on totalPageNum and maxPageNum', () => {
    render(<Pagination totalPageNum={10} maxPageNum={5} />);
  ...
  it('triggers onChange with the correct page number when a page is clicked', () => {
    ...
    render(<Pagination totalPageNum={10} maxPageNum={5} onChange={onChangeMock} />);
  ...
  it('navigates to the next set of pages when the right arrow is clicked', () => {
    render(<Pagination totalPageNum={10} maxPageNum={5} currentPageIndex={2} />);
  ...
  it('navigates to the previous set of pages when the left arrow is clicked', () => {
    render(<Pagination totalPageNum={10} maxPageNum={5} currentPageIndex={7} />);
  ...
  it('navigates to the first page when the double left arrow is clicked', () => {
    render(<Pagination totalPageNum={10} maxPageNum={5} currentPageIndex={7} hasDoubleArrow={true} />);
  ...
  it('navigates to the last page when the double right arrow is clicked', () => {
    render(<Pagination totalPageNum={10} maxPageNum={5} currentPageIndex={2} hasDoubleArrow={true} />);
