...
const Help = () => {
  ...
  return (
    <div className="flex flex-col gap-24 py-3">
      <div>
        <h2 className="font-bold text-xl bg-white">자주하는 질문</h2>
      ...
      <div className="relative">
        <h2 className="font-bold text-xl bg-white">레이아웃 설명</h2>
      ...
      <div className="relative">
        <h2 className="font-bold text-xl bg-white">페이지 설명</h2>
        <iframe src="/stats" className="w-full h-[600px] border-2 my-8"></iframe>
